...
<PricingTable 
  data={[
    {category: 'Saadi Town', price: 176, rent: 'Days', roi: '3 Deaths'},
    {category: 'Gulshan-i-Hadeed', price: 173, rent: 'Days', roi: '2 Deaths'},
    {category: 'Airport Old Area', price: 158, rent: 'Days', roi: 'Power Outage'},
    {category: 'Bahria Town Karachi', price: 4.8, rent: '30 Min', roi: 'Zero Deaths'}
  ]}
...
## Why Smart Investors Choose Infrastructure Over Location
