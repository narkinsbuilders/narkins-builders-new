...
This isn't another routine announcement. This is systematic enforcement backed by officer accountability measures that change the compliance landscape for Karachi property investors.
...
<EChartsColumnChart
  data={[
    { name: "Central", value: 185 },
    { name: "East", value: 91 },
    { name: "South", value: 55 },
    { name: "Korangi", value: 18 },
    { name: "West", value: 7 },
    { name: "Keamari", value: 1 }
  ]}
