...
<EChartsLineChart
  data={[
    {month: 'Year 1', 'ARX Guaranteed': 15, 'HCR Actual': 23, 'NBR Projected': 21, 'Market Average': 15},
    {month: 'Year 2', 'ARX Guaranteed': 15, 'HCR Actual': 24, 'NBR Projected': 22, 'Market Average': 16},
    {month: 'Year 3', 'ARX Guaranteed': 15, 'HCR Actual': 25, 'NBR Projected': 23, 'Market Average': 17},
    {month: 'Year 4', 'ARX Guaranteed': 15, 'HCR Actual': 24, 'NBR Projected': 22, 'Market Average': 16},
    {month: 'Year 5', 'ARX Guaranteed': 15, 'HCR Actual': 23, 'NBR Projected': 21, 'Market Average': 15}
  ]}
  title="5-Year ROI Performance: Proptech vs Traditional Ownership"
  xField="month"
  yField={['ARX Guaranteed', 'HCR Actual', 'NBR Projected', 'Market Average']}
  smooth={true}
  showArea={false}
