...
<EChartsPolarBarChart
  data={[
    {area: 'Existing Inventory', count: 1552},
    {area: 'Under Construction', count: 1680},
    {area: 'Planned (2026-2027)', count: 724}
  ]}
  title="Karachi Grade A & B Apartment Supply Distribution"
  polarIndex="area"
  radiusAxis="count"
...
<EChartsHeatmapChart
  data={[
    {rate: '18%', tenure: '15 Years', value: 418000},
    {rate: '18%', tenure: '20 Years', value: 362000},
    {rate: '20%', tenure: '15 Years', value: 452000},
    {rate: '20%', tenure: '20 Years', value: 485000},
    {rate: '22%', tenure: '15 Years', value: 488000},
    {rate: '22%', tenure: '20 Years', value: 526000}
  ]}
  title="Monthly EMI for PKR 2.8 Cr Loan (Different Rates & Tenures)"
  xField="tenure"
  yField="rate"
  valueField="value"
  height={350}
...
<ECharts3DBarChart
  data={[
    {location: 'Hill Crest Residency', pricing: 32000, demandIndex: 85},
    {location: 'NBR Apartments', pricing: 30000, demandIndex: 80},
    {location: 'DHA Phase 5', pricing: 45000, demandIndex: 70},
    {location: 'Gulshan-e-Iqbal', pricing: 25000, demandIndex: 75}
  ]}
  title="Pricing vs. Demand Index: Karachi Apartment Locations"
  xField="location"
  yField="pricing"
  zField="demandIndex"
  xLabel="Location"
  yLabel="Price (PKR/sq ft)"
  zLabel="Demand Score"
  height={450}
/>
...
<EChartsLiquidFillChart
  value={72}
  title="Mid-Range Apartment Occupancy Rate"
  subtitle="Karachi Grade B Units (2024-2025)"
  color={['#52c41a', '#95de64']}
...
<EChartsScatterChart
  data={[
    {x: 30, y: 250, size: 3, category: 'Developer Plan (3Y)'},
    {x: 40, y: 280, size: 3, category: 'Developer Plan (3Y)'},
    {x: 60, y: 420, size: 20, category: 'Bank Mortgage (20Y)'},
    {x: 75, y: 485, size: 20, category: 'Bank Mortgage (20Y)'},
    {x: 105, y: 526, size: 20, category: 'Bank Mortgage (20Y)'}
  ]}
  title="Down Payment vs. Monthly EMI by Financing Type (PKR Thousands)"
  xField="x"
  yField="y"
  sizeField="size"
  categoryField="category"
  xLabel="Down Payment (PKR Lakh)"
  yLabel="Monthly EMI (PKR Thousand)"
  height={400}
/>
