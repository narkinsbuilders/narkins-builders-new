...
Riviera Group unveiled Sky Garden, marketing it as **Pakistan's largest 3-bedroom apartment**, according to ProPakistani reports from October 2025. The claim is bold, the marketing is aggressive, and the implied message is clear: bigger equals better.

But does it? For property investors focused on returns rather than bragging rights, apartment size tells only part of the story. What matters is how space translates into rental income, resale value, and actual livability.
...
<EChartsHeatmapChart
  data={[
    {x: 'Rental Yield', y: 'Location Quality', value: 92},
    {x: 'Rental Yield', y: 'Layout Efficiency', value: 78},
    {x: 'Rental Yield', y: 'Apartment Size', value: 45},
    {x: 'Rental Yield', y: 'Finishing Quality', value: 72},
    {x: 'Resale Value', y: 'Location Quality', value: 95},
    {x: 'Resale Value', y: 'Layout Efficiency', value: 68},
    {x: 'Resale Value', y: 'Apartment Size', value: 52},
    {x: 'Resale Value', y: 'Finishing Quality', value: 85},
    {x: 'Tenant Demand', y: 'Location Quality', value: 88},
    {x: 'Tenant Demand', y: 'Layout Efficiency', value: 82},
    {x: 'Tenant Demand', y: 'Apartment Size', value: 38},
    {x: 'Tenant Demand', y: 'Finishing Quality', value: 75}
  ]}
  title="Value Driver Impact Matrix: What Actually Drives Returns"
...
<EChartsPieChart
  data={[
    {type: '1-2 Bedrooms', value: 48, color: '#10b981'},
    {type: '3 Bedrooms Standard', value: 38, color: '#3b82f6'},
    {type: '3 Bedrooms Large', value: 11, color: '#f59e0b'},
    {type: '4+ Bedrooms', value: 3, color: '#8b5cf6'}
  ]}
  title="Rental Demand Distribution by Apartment Type (Karachi 2025)"
  showLegend={true}
  showLabel={true}
/>
...
**Hill Crest Residency** maintains 90%+ occupancy not because the units are the largest, but because the sizing matches market demand:

* 2-bedroom units: 1100-1300 sq ft (high demand segment)
* 3-bedroom units: 1400-1700 sq ft (mainstream market)
* Pricing: Aligned with renter capacity
* Result: Minimal vacancy, consistent income
...
<EChartsStatistic
  value={32}
  title="Higher Annual Maintenance Cost (2200 sq ft vs 1500 sq ft)"
  prefix="+"
  suffix="%"
  valueColor="#ef4444"
/>
...
* 2-Bedroom: 1100-1400 sq ft (maximum demand)
* 3-Bedroom: 1400-1800 sq ft (mainstream market)
* 4-Bedroom: 1900-2400 sq ft (luxury segment)
...
**Narkin's Boutique Residency** units are sized specifically within these sweet spots based on 30 years of market data showing what actually rents quickly and maintains value.

## Location Still Trumps Everything

<EChartsProgressBar
  percentage={89}
  title="Buyers Choosing Location Over Size (When Forced to Prioritize)"
  color="#10b981"
/>
...
<EconomicGauge
  data={[
    {value: 85, name: 'Standard Size (1400-1700 sq ft)', title: {offsetCenter: ['0%', '-35%']}, detail: {offsetCenter: ['0%', '-20%']}},
    {value: 62, name: 'Above Average (1800-2000 sq ft)', title: {offsetCenter: ['0%', '-5%']}, detail: {offsetCenter: ['0%', '10%']}},
    {value: 28, name: 'Oversized (2100-2300 sq ft)', title: {offsetCenter: ['0%', '25%']}, detail: {offsetCenter: ['0%', '40%']}},
    {value: 12, name: 'Record Size (2400+ sq ft)', title: {offsetCenter: ['0%', '55%']}, detail: {offsetCenter: ['0%', '70%']}}
  ]}
  title="Market Liquidity Score by Apartment Size Category"
  subtitle="Higher Score = Faster Sale Time & More Potential Buyers"
/>
...
**Hill Crest Residency** and **Narkin's Boutique Residency** don't compete on "largest apartment" claims. They compete on delivering the combination of location, sizing, and amenities that generates consistent rental income and appreciation.
