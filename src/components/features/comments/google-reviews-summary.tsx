...
export function GoogleReviewsSummaryCard({ 
  ...
  const renderOverallStars = (rating: number) => {
    ...
    return Array.from({ length: 5 }, (_, i) => {
      if (i < fullStars) {
        return <Star key={i} className="h-3.5 w-3.5 sm:h-4 sm:w-4 lg:h-5 lg:w-5 text-amber-400 fill-amber-400" />;
        ...
        return <Star key={i} className="h-3.5 w-3.5 sm:h-4 sm:w-4 lg:h-5 lg:w-5 text-gray-300" />;
      }
    });
  };
  ...
  if (summary.totalReviews === 0) {
    return (
      <div className={cn('bg-white border border-gray-200 rounded-xl p-3 sm:p-4 lg:p-5 hover:border-gray-300 hover:shadow-md transition-all duration-200', className)}>
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm sm:text-base">Be the first to review this article!</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <motion.div 
      ...
      className={cn('bg-white border border-gray-200 rounded-xl p-3 sm:p-4 lg:p-5 hover:border-gray-300 hover:shadow-md transition-all duration-200', className)}
    >
            ...
            return (
              ...
              >
                <div className="flex items-center gap-0.5 sm:gap-1 min-w-0">
                  <span className="text-xs sm:text-sm lg:text-sm font-medium text-gray-700">{rating}</span>
