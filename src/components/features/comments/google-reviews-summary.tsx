...
export function GoogleReviewsSummaryCard({ 
  ...
  return (
    <motion.div 
      ...
      className={cn('bg-white border border-gray-200 rounded-xl p-4 sm:p-6', className)}
    >
          ...
          {[5, 4, 3, 2, 1].map((rating) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'w-full flex items-center gap-2 sm:gap-3 p-3 sm:p-2 rounded-lg transition-all duration-200 group min-h-[44px]',
                  isActive 
              ...
              >
                ...
                <div className="flex-1 relative">
                  <div className="w-full bg-gray-200 rounded-full h-3 sm:h-2">
                    <motion.div
                      className={cn(
                        'h-3 sm:h-2 rounded-full transition-colors duration-200',
