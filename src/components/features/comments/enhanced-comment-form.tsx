    ...
    <form onSubmit={handleCommentSubmit} className="space-y-4">
     ...
     <div className="flex items-center justify-between pt-1">
      ...
      <Button 
       ...
       className="bg-primary hover:bg-primary/90 text-white px-5 py-2 h-9 rounded-lg transition-colors"
      >
    ...
    <form onSubmit={handleFinalSubmit} className="space-y-4">
     <div className="relative">
      <div className="text-sm text-gray-600 mb-3 p-3 bg-gray-50 rounded-lg border">
       Your comment: "{formData.content.substring(0, 100)}{formData.content.length > 100 ? '...' : ''}"
      </div>
     </div>
     ...
     <div className="space-y-3">
      ...
      <div className="text-xs text-gray-500 bg-blue-50 border border-blue-100 rounded-lg p-3">
       <Mail className="inline h-3 w-3 mr-1 text-blue-500" />
       Receive updates on new project launches, important announcements, or responses to your comment by providing your email.
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
       ...
       <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
        <Button 
         ...
         variant="outline"
         disabled={isSubmitting}
         className="px-3 py-2 h-9 rounded-lg transition-colors w-fit"
        >
       ...
       <div className="flex justify-end sm:justify-start">
        <Button 
         ...
         className="bg-primary hover:bg-primary/90 text-white px-5 py-2 h-9 rounded-lg transition-colors w-fit"
        >
         {isSubmitting ? (
          <>
