...
export function GoogleReviewItem({ 
  ...
  return (
    <motion.div
      ...
      className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 md:p-6 lg:p-8 shadow-sm hover:shadow-lg lg:hover:shadow-xl transition-all duration-300 will-change-transform hover:-translate-y-1 lg:hover:border-gray-300 lg:hover:scale-[1.02]"
    >
