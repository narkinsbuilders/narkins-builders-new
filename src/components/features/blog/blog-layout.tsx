 ...
 <div className="relative p-8 lg:p-10 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-500 overflow-hidden">
  ...
  <div className="relative z-10">
   ...
   <a
    ...
    className="inline-flex items-center bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700 transition-all duration-300 text-lg shadow-lg hover:shadow-xl transform hover:scale-105 min-h-[44px]"
   >
