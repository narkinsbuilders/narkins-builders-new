...
export const LocalBusinessSchema = () => {
 const schema = {
  ...
  "description": "Leading real estate developer in Karachi specializing in luxury apartments and residential projects in Bahria Town since 1994. Over 30 years of experience in premium residential construction.",
  ...
  "serviceType": ["Real Estate Development", "Luxury Apartment Construction", "Property Investment"],
  "knowsAbout": [
   "Luxury Apartments",
   ...
   "itemListElement": [
    {
     ...
     "itemOffered": {
      ...
      "description": "2, 3 & 4 bedroom luxury apartments in Bahria Town Karachi"
     }
    },
    {
     "@type": "Offer",
