...
async function handleCreateComment(
 ...
 try {
  ...
  const autoApproveThreshold = parseFloat(process.env.AUTO_APPROVE_THRESHOLD || '0.8');
  const autoApprove = process.env.AUTO_APPROVE_COMMENTS === 'true' && moderationScore >= autoApproveThreshold;
