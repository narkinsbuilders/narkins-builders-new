...
const youtubeVideos = [
  ...
  { id: "hEy1bb6vprY", title: "Hill Crest Residency Walkthrough", type: "youtube" },
  ...
  return (
    <main>
      <Head>
        ...
        <link rel="canonical" href="https://www.narkinsbuilders.com/hill-crest-residency" />
            ...
            <div className="relative isolate overflow-hidden py-20 pt-5 sm:py-[28px]">
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:mx-0">
                  <h2 className="text-4xl tracking-tight text-black sm:text-7xl">Hill Crest Residency</h2>
                  <p className="mt-6 text-lg leading-8 text-gray-800">
                    ...
                    <br /><br />
                    Explore our exquisite 2, 3, and 4-bedroom apartments for sale in Bahria Town Karachi. Each residence features a spacious lounge, elegant dining area, and stunning panoramic views. Find the perfect home you've always dreamed of for your family's future.
                  </p>
                </div>
              </div>
            </div>
