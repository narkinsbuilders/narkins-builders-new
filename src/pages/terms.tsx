 ...
 const SectionCard: React.FC<{
  ...
  return (
   ...
   >
    ...
    >
     <h2 className="text-xl lg:text-2xl text-gray-900 pr-4">
      {title}
     </h2>
     {isExpanded ? (
      ...
      <div className="lg:col-span-1 mb-12 lg:mb-0">
       <div className="lg:sticky lg:top-24">
        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
         <h3 className=" text-gray-900 mb-4 text-lg">Table of Contents</h3>
         <nav className="space-y-2">
          {sections.map((section) => (
           ...
           >
            <span className="text-sm text-gray-500">{section.icon}</span>
            {section.title}
           </button>
          ))}
         </nav>
      ...
      <div className="lg:col-span-3 space-y-8">
       ...
       <SectionCard id="acceptance" title="1. Acceptance of Terms" defaultExpanded={true}>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
         <p className="text-sm text-yellow-800">
          Important: Please read these terms carefully before using our services or making any property investments.
         </p>
        </div>
       </SectionCard>
       ...
       <SectionCard id="company-info" title="2. Company Information">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
         <h4 className=" text-gray-900 mb-3 text-lg">Company Details</h4>
       ...
       <SectionCard id="property-info" title="3. Property Information and Representations">
        ...
        <h4 className=" text-gray-900 mb-3 text-lg">Property Disclaimers</h4>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
         <p className="text-sm text-blue-800">
          Tip: Always verify property details with our sales team before making investment decisions.
         </p>
        </div>
       </SectionCard>
       ...
       <SectionCard id="investment-risks" title="4. Investment Risks and Disclaimers">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
         <h4 className=" text-red-900 mb-3 text-lg">Investment Risks</h4>
       ...
       <SectionCard id="booking-payment" title="5. Booking and Payment Terms">
        ...
        <h4 className=" text-gray-900 mb-3 text-lg">Cancellation Policy</h4>
       ...
       <SectionCard id="website-use" title="7. Website Use and Prohibited Activities">
        ...
        <h4 className=" text-gray-900 mb-3 text-lg">Prohibited Activities</h4>
        <ul className="list-disc list-inside space-y-2 text-gray-700">
       ...
       <SectionCard id="liability" title="8. Limitation of Liability">
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
         <h4 className=" text-yellow-900 mb-3 text-lg">Liability Limitations</h4>
       ...
       <SectionCard id="termination" title="10. Termination">
        ...
        <div className="grid md:grid-cols-2 gap-4">
         <div className="bg-gray-50 rounded-lg p-4">
          <h5 className=" text-gray-900 mb-2">Grounds for Termination</h5>
          <ul className="text-sm text-gray-700 space-y-1">
         ...
         <div className="bg-gray-50 rounded-lg p-4">
          <h5 className=" text-gray-900 mb-2">Effect of Termination</h5>
          <ul className="text-sm text-gray-700 space-y-1">
       ...
       <SectionCard id="dispute-resolution" title="12. Dispute Resolution">
        ...
        <div className="space-y-4">
         <div className="flex items-start gap-4">
          ...
          <div>
           <h5 className=" text-gray-900 mb-1">Direct Negotiation</h5>
       ...
       <SectionCard id="modifications" title="13. Modifications to Terms">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
         <p className="text-sm text-blue-800">
          Stay Updated: Bookmark this page and check back regularly for any updates to our terms.
         </p>
        </div>
       </SectionCard>
