...
const Privacy = () => {
  ...
  const sections = [
    ...
    { id: 'information-we-collect', title: 'Information We Collect', icon: '2' },
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://narkinsbuilders.com/privacy-policy" />
      </Head>
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
                How we protect and handle your personal information with transparency and care
              </p>
            </motion.div>
          </div>
        </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 text-sm">Your personal and financial information with industry-leading security</p>
                </div>
                <div className="text-center">
                  <div className="w-14 h-14 bg-gray-900 rounded-xl mx-auto mb-4 flex items-center justify-center">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                  </div>
                  <h3 className="font-semibold text-gray-900 mb-2">We Use Data</h3>
                  <p className="text-gray-600 text-sm">Only to provide better real estate services and communicate with you</p>
                </div>
                <div className="text-center">
                  <div className="w-14 h-14 bg-gray-900 rounded-xl mx-auto mb-4 flex items-center justify-center">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                  ...
                  <p className="text-gray-600 text-sm">Access, update, or delete your data anytime by contacting us</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-4 lg:gap-12">
            ...
            <div className="lg:col-span-3 space-y-8">
              ...
              <SectionCard id="introduction" title="1. Introduction" defaultExpanded={true}>
                <p className="mb-4">
                  Narkin's Builders is committed to protecting your privacy and personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, use our services, or engage with our real estate projects.
                </p>
                <p>
                  By using our services, you agree to the collection and use of information in accordance with this policy. We are dedicated to maintaining the highest standards of data protection and transparency in all our operations.
                </p>
              </SectionCard>

              <SectionCard id="information-we-collect" title="2. Information We Collect">
                <p className="mb-6">We collect several types of information from and about users of our website and services:</p>
                ...
                <h4 className="font-semibold text-gray-900 mb-3 text-lg">Technical Information</h4>
              ...
              <SectionCard id="how-we-collect" title="3. How We Collect Information">
                <p className="mb-4">We collect information through various methods:</p>
                <ul className="list-disc list-inside space-y-3 text-gray-700">
                  <li><strong>Direct interactions</strong> when you contact us or fill out forms</li>
                  <li><strong>Website cookies</strong> and tracking technologies</li>
                  <li><strong>Third-party services</strong> such as Google Analytics and Google Maps</li>
                  <li><strong>Social media platforms</strong> and advertising networks</li>
                  <li><strong>Public records</strong> and databases for verification purposes</li>
                  <li><strong>Business partners</strong> and referral sources</li>
                </ul>
              </SectionCard>

              <SectionCard id="how-we-use" title="4. How We Use Your Information">
              ...
              <SectionCard id="information-sharing" title="5. Information Sharing and Disclosure">
                ...
                <ul className="list-disc list-inside space-y-3 text-gray-700">
                  ...
                  <li><strong>Protection of rights</strong> - To protect our legal rights and safety</li>
                </ul>
              </SectionCard>
              ...
              <SectionCard id="cookies" title="7. Cookies and Tracking Technologies">
                <p className="mb-4">
                ...
                <p className="mt-4 text-sm bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <strong>Note:</strong> You can manage cookie preferences through your browser settings or our cookie consent tool.
                </p>
              </SectionCard>

              <SectionCard id="third-party" title="8. Third-Party Services">
                <p className="mb-4">Our website and services integrate with various third-party services:</p>
                <ul className="list-disc list-inside space-y-3 text-gray-700">
                  <li><strong>Google Services</strong> - Analytics, Maps, and Advertising</li>
                  <li><strong>Social Media Platforms</strong> - Facebook, Instagram, WhatsApp</li>
              ...
              <SectionCard id="your-rights" title="9. Your Rights and Choices">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-900 mb-2">Access Rights</h5>
                    <p className="text-sm text-gray-700">Request copies of your personal data</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-900 mb-2">Correction Rights</h5>
                    <p className="text-sm text-gray-700">Update or correct your information</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-900 mb-2">Deletion Rights</h5>
                    <p className="text-sm text-gray-700">Request deletion of your data</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h5 className="font-semibold text-gray-900 mb-2">Communication Preferences</h5>
              ...
              <SectionCard id="international" title="11. International Data Transfers">
                <p>
                  Your information may be transferred to and processed in countries other than Pakistan. We ensure appropriate safeguards are in place to protect your personal information during such transfers.
                </p>
              </SectionCard>
              ...
              <SectionCard id="contact" title="14. Contact Information" defaultExpanded={true}>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h5 className="font-semibold text-gray-900 mb-3">Email Us</h5>
                    ...
                    <div>
                      <h5 className="font-semibold text-gray-900 mb-3">WhatsApp</h5>
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-8 text-lg">
              Discover premium apartments in Bahria Town Karachi with complete transparency and privacy protection.
            </p>
