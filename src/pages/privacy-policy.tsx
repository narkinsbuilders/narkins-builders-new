 ...
 return (
  <>
   <Head>
    ...
    <link rel="canonical" href="https://www.narkinsbuilders.com/privacy-policy" />
   </Head>
     ...
     <div className="lg:grid lg:grid-cols-4 lg:gap-12">
      ...
      <div className="lg:col-span-3 space-y-8">
       ...
       <SectionCard id="information-we-collect" title="2. Information We Collect">
        ...
        <h4 className=" text-gray-900 mb-3 text-lg">Personal Information</h4>
        ...
        <h4 className=" text-gray-900 mb-3 text-lg">Technical Information</h4>
       ...
       <SectionCard id="information-sharing" title="5. Information Sharing and Disclosure">
        ...
        <ul className="list-disc list-inside space-y-3 text-gray-700">
         <li>With your consent - When you explicitly agree to information sharing</li>
         <li>Service providers - Third parties who assist in our operations</li>
         ...
         <li>Protection of rights - To protect our legal rights and safety</li>
        </ul>
       </SectionCard>
       ...
       <SectionCard id="cookies" title="7. Cookies and Tracking Technologies">
        ...
        <p className="mt-4 text-sm bg-blue-50 border border-blue-200 rounded-lg p-4">
         Note: You can manage cookie preferences through your browser settings or our cookie consent tool.
        </p>
       </SectionCard>
       ...
       <SectionCard id="third-party" title="8. Third-Party Services">
        ...
        <ul className="list-disc list-inside space-y-3 text-gray-700">
         ...
         <li>Social Media Platforms - Facebook, Instagram, WhatsApp</li>
       ...
       <SectionCard id="your-rights" title="9. Your Rights and Choices">
        ...
        <div className="grid md:grid-cols-2 gap-4">
         ...
         <div className="bg-gray-50 rounded-lg p-4">
          <h5 className=" text-gray-900 mb-2">Communication Preferences</h5>
