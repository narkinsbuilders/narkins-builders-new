...
import { ProjectGridSkeleton } from '@/components/common/skeleton/skeleton';
...
export default function NarkinsBoutiqueResidency() {
  ...
  // Loading state for the page - start with false to prevent hydration mismatch
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-primary text-sm uppercase tracking-wider">Our Portfolio</span>
                <div className="w-8 h-0.5 bg-primary"></div>
              </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden max-w-4xl mx-auto">
                      ...
                      <div className="p-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                          ...
                          <div>
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center gap-3">
                                ...
                                <span className="text-gray-600">Status: <span className=" text-gray-900">Completed</span></span>
                              </div>
                              <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-primary rounded-full"></div>
                                <span className="text-gray-600">Type: <span className=" text-gray-900">Residential Development</span></span>
                              </div>
                              <div className="flex items-center gap-3">
                                <div className="w-2 h-2 bg-primary rounded-full"></div>
                                <span className="text-gray-600">Location: <span className=" text-gray-900">Karachi, Pakistan</span></span>
                              </div>
                            </div>
                          </div>
                          ...
                          {/* Location Map */}
                          <div>
                            <h4 className="text-lg text-gray-900 mb-4">Project Location</h4>
