 ...
 */
export function transformCommentToGoogleReview(comment: Comment): GoogleReviewData {
...
function generateReviewsSummary(comments: Comment[]): GoogleReviewsSummary {
  ...
  const ratingBreakdown = comments.reduce((breakdown, comment) => {
 ...
 */
export function sortReviewsGoogleStyle(reviews: GoogleReviewData[]): GoogleReviewData[] {
 ...
 */
export function filterReviewsByRating(reviews: GoogleReviewData[], rating: number): GoogleReviewData[] {
 ...
 */
export function paginateReviews(reviews: GoogleReviewData[], page: number = 1, limit: number = 10): {
  reviews: GoogleReviewData[];
  hasMore: boolean;
  total: number;
} {
