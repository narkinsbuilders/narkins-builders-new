  ...
  return {
    ...
    faq(
      ...
      return requester<
        ...
        FaqQueryVariables
      >(FaqDocument, variables, options)
    },
    faqConnection(
      variables?: FaqConnectionQueryVariables,
      options?: C
    ): Promise<{
      data: FaqConnectionQuery
      errors?: {
        message: string
        locations: { line: number; column: number }[]
        path: string[]
      ...
      return requester<
        ...
        FaqConnectionQueryVariables
      >(FaqConnectionDocument, variables, options)
    },
  }
}
